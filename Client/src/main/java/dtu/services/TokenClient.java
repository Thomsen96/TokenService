...
public class TokenClient {
	...
	public static final String HTTP_LOCALHOST_8080 = "http://token-service-server:8182";
	public static final String HTTP_DOCKER_LOCALHOST_8181 = "http://token-service-server:8182";
